...
public final class Constants {
    ...
    public static final double DRIVE_MAX_SPEED_INC = 0.075;
    public static final double DRIVE_MAX_ROTATE_INC = 0.075;

    // initial values for driver-specific constants, updated by updateAllDriverConstants()
